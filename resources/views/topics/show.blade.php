        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 topic-content">
                ...
                <div class="panel-body">
                    ...
                    @can('update', $topic)
                        <div class="operate">
                            ...
                            <form action="{{ route('topics.destroy', $topic->id) }}" method="post" onsubmit="return delSure()">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
            ...
            <div class="panel panel-default topic-reply">
                <div class="panel-body">
                    ...
                    @include('topics._reply_list', ['replies' => $topic->replies()->with('user','topic')->latest()->get()])
                </div>
            </div>
        </div>
    </div>
